...
const MailingList = () => (
  <div id="mc_embed_signup" className={ styles.wrapper }>
    <h2>Mailing List</h2>
    <p>Want to know all the things? Announcements? Beta Updates? <br />
      Subscribe to our list. No spam, no passing your email address around.</p>
    <form action="//nubu.us14.list-manage.com/subscribe/post?u=eb1327a1f807a88a138732c23&id=a47412c1f4" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank" noValidate>
      <div id="mc_embed_signup_scroll">
        <div className="mc-field-group">
          ...
          <input role='button' type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" className="button" />
        </div>
